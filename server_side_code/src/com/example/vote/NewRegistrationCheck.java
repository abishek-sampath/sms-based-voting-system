...
public class NewRegistrationCheck {
...
//	String line=null;
	...
	public static void new_registration_check()
	{
		    ...
		    public void run() {
		        ...
		        //   	nameValuePairs.add(new BasicNameValuePair("id","777"));
		         //  	nameValuePairs.add(new BasicNameValuePair("name","eeeeeeeee"));
		        	...
		        	//       HttpPost httppost = new HttpPost("http://10.0.2.2/votingfinal/android_registration_flag.php");
